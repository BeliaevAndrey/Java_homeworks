...
//        }
    ...
    String box = "" +
            ...
            "Mini Tower;InWin;ENR027 Black RB-S400T70 2*USB+AirDuct+Audio mATX\n" +
...
/*
            for (String subS : s.split(";")) {
                if (subS.toLowerCase().contains("intel") ||
                        subS.contains("AMD")) {
                    brand = subS;
                } else if (subS.contains("i3") ||
                        subS.contains("i5") ||
                        subS.contains("i7") ||
                        subS.contains("Xeon") ||
                        subS.contains("Phenom") ||
                        subS.contains("FX-") ||
                        subS.contains("Athlon") ||
                        subS.contains("Opteron")
                ) {
                    family = subS;
                } else if (subS.contains("AM2") ||
                        subS.contains("AM3") ||
                        subS.contains("FM2") ||
                        subS.contains("1155") ||
                        subS.contains("2011") ||
...
Материнская плата
		Asus;H97-PRO;1150;iH97;DDR3;ATX
		Asus;Z97-PRO;1150;iZ97;DDR3;ATX
		ASUS;B85M-E;LGA1150;B85;DDR3;microATX
		ASUS;B85M-G;1150;B85;DDR3;mATX
		ASUS;B85-PLUS;1150;B85;DDR3;ATX
		ASUS;H81M-A;LGA1150;H81;DDR3;mATX
		ASUS;M5A78L-M LX3;AM3+;AMD 760G;DDR3;mATX
		ASUS;SABERTOOTH 990FX R2.0;AM3+;AMD 990FX;DDR3;ATX
		Biostar;A780L3B;AM3;HT5.2GT/s;DDR3;Micro ATX
		ASUS;M5A97 R2.0;Socket AM3+;AMD 970;DDR3; ATX
        ...
        Накопитель SSD
		SSD;120ГБ;2.5 Intel 530 SSDSC2BW120A4K5 (SATA III)
		SSD;500ГБ;2.5 Samsung 840 EVO MZ-7TE500BW (SATA III)
		SSD;512ГБ;2.5 Samsung 840 PRO MZ-7PD512BW (SATA III)
		SSD;128ГБ;2.5 Samsung 840 PRO MZ-7PD128BW (SATA III)
		SSD;80 Gb;SATA 6Gb/s Intel 530 Series SSDSC2BW080A401 2.5 MLC
		SSD;240Gb;Crucial Original SATA-III CT240M500SSD1 2.5 w175Mb/s
		SSD;120ГБ;2.5 Kingston SSDNow V300 SV300S3N7A/120G (SATA III)
		SSD;256Gb;Sandisk SATA-III SDSSDP-256G-G25 2.5 w350Mb/s r490Mb/s
		SSD;120Gb;OCZ Original SATA-III VTR150-25SAT3-120G Vector 150 2.5
		SSD;128Gb;Crucial SATA-III CT128M550SSD1 M550 2.5 w500Mb/s r550Mb/s

        Процессор
		AMD;Phenom II X4 925;sAM3
		AMD;Athlon II X2 220;Socket AM3
		AMD;Phenom II X4 Deneb 945;AM3
		AMD;X4 FX-4350;AM3+;(FD4350FRW4KHK) (4.2/5200/8Mb) OEM
		AMD;Athlon II X3 455;SocketAM3;(3.30ГГц, 3x512КБ, HT2000МГц) (96506)
		AMD;FX-8120;SocketAM3+;(3.10ГГц, 4x2048КБ+8МБ, HT2000МГц)oem
		INTEL;Core i7 4960X;LGA2011;BX80633I74960X 3.60/15M Box
		Intel;Core i5 4570;LGA1150;(3.2GHz) 6MB OEM (SR14E)
		INTEL;Core i7 4960X;LGA2011;CM8063301292500 3.60/15M Tray
		Intel;Core i3-3240;Socket1155;(3.40ГГц, 2x256КБ+3МБ, EM64T, GPU) (109600)

        Корпус
    	Midi Tower  InWin    EC022Black 450W USB+Audio ATX (6020428)
		Midi Tower  InWin    EC027Black 450W USB+Audio ATX (6026950)
		MiniTower   InWin    ENR027 Black RB-S400T70 2*USB+AirDuct+Audio mATX
		Full Tower  InWin    BX141 BLack 600W U2AF4+U3.0 GRONE (6102963)
